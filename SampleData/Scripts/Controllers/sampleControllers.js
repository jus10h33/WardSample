...
.controller("findSampleCtrl", function ($scope, Sample, $stateParams) {
...
.controller("prevSampleCtrl", function ($scope, Sample, $stateParams) {
...
.controller("nextSampleCtrl", function ($scope, Sample, $stateParams) {
...
.controller("addSampleCtrl", function ($scope, Sample, $stateParams) {
...
.controller("updateSampleCtrl", function ($scope, Sample, $stateParams) {
...
.controller("deleteSampleCtrl", function ($scope, Sample, $stateParams) {
